...
class JustRelaxService : Service() {
    ...
    private fun createNotification(): Notification {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setLargeIcon(BitmapFactory.decodeResource(resources, R.drawable.sym_def_app_icon))
        ...
        if (isMasterPlaying) {
            builder.addAction(R.drawable.ic_media_pause, "Pause", pPause)
        } else {
            builder.addAction(R.drawable.ic_media_play, "Play", pPlay)
        }
